...
- 📱 **PWA поддержка** — установка на устройство, офлайн-режим, push-уведомления
...
FastPay Connect поддерживает PWA для установки на устройства пользователей.
...
- 📴 **Офлайн режим** — работа без интернета с кэшированием
- 🔔 **Push-уведомления** — мгновенные уведомления о платежах
- 🚀 **Быстрая загрузка** — кэширование статических ресурсов
- 📱 **Адаптивность** — оптимально на любом устройстве

📖 **Полная документация:** [docs/PWA.md](./docs/PWA.md)
