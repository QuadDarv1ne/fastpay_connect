"""Tests for CloudPayments payment gateway."""

import pytest
from app.payment_gateways.cloudpayments import gateway, handle_cloudpayments_webhook


class TestCloudPaymentsSignature:
    """Тесты подписи CloudPayments."""
...
@pytest.mark.asyncio
class TestCloudPaymentsCreatePayment:
    """Тесты создания платежа CloudPayments."""
    ...
    async def test_create_payment_payload(self, mocker):
        ...
        assert "payments" in call_args[0][1]
